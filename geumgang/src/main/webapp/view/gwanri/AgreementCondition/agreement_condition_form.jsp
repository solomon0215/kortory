...
<body>
<table>
<form:form action="agreementConditionWritePro" commandName="agreementConditionCommand" id="frm" method="POST" >
    
		<h2 class="w3-center">협약조건안</h2><br /><br />
		<div>
			<p>"Kortory"(이하 "갑"이라 한다)는 협약업체(이하 "을"이라 한다)에게 다음과 같이 협약 조건을 신청한다.<br /> <br /> 제1조(목적)<br /> 본
				...
				<form:input path="agreementConditionRatio" class="w3-input w3-center" type="text"  />
				<p>퍼센트를 지급하고 나머지 퍼센트는 "갑"이 갖는 것으로 한다. <br /> ② "갑"은 정산 진행 시 "을"이 이용한</p>
				
				<form:input path="agreementConditionSett" class="w3-input w3-center" type="text" />
				...
				<form:input path="agreementConditionDate" class="w3-input w3-center" 
