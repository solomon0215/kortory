...
<div class="menubar" style="margin-bottom:3%;">
	<div class="w3-bar w3-black w3-text-center">
	  ...
	  style="width:16.6%">&nbsp; HOME</a>
	  <a href="http://localhost:8080/geumgang/intro" class="w3-bar-item w3-button fa fa-info w3-hover-lime" 
	  style="width:16.6%">&nbsp; 회사소개</a>
	  <a href="http://localhost:8080/geumgang/event/list" class="w3-bar-item w3-button fa fa-plane w3-hover-yellow" 
	  style="width:16.6%">&nbsp; 행사상품</a>
	  <a href="#" class="w3-bar-item w3-button fa fa-handshake-o w3-hover-cyan" 
	  style="width:16.6%">&nbsp; 마이페이지</a>
	  <a href="apply" class="w3-bar-item w3-button fa fa-user-circle-o w3-hover-orange" 
	  style="width:16.6%">&nbsp; 채용페이지</a>
	  <a href="#" class="w3-bar-item w3-button fa fa-user-circle-o w3-hover-orange" 
	  style="width:16.6%">&nbsp; 로그아웃</a>
	</div>
</div>	
</header>
